...
// $ANTLR 2.7.6 (2005-12-22): "OBJ.g" -> "OBJLexer.java"$
...
public class OBJLexer extends antlr.CharScanner implements OBJParserTokenTypes, TokenStream
 {
public OBJLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public OBJLexer(Reader in) {
	this(new CharBuffer(in));
}
public OBJLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
@SuppressWarnings("unchecked")
public OBJLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("g", this), new Integer(4));
	literals.put(new ANTLRHashString("mtllib", this), new Integer(6));
	literals.put(new ANTLRHashString("f", this), new Integer(12));
	literals.put(new ANTLRHashString("usemtl", this), new Integer(7));
	literals.put(new ANTLRHashString("n", this), new Integer(11));
	literals.put(new ANTLRHashString("v", this), new Integer(8));
	literals.put(new ANTLRHashString("vt", this), new Integer(10));
}
